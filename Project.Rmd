...
AccidentData.train <- AccidentData[AccidentData.train.ind, c(10,11,33,17,18,23,25,26,27,30,7)]
AccidentData.test <- AccidentData[AccidentData.test.ind, c(10,11,33,17,18,23,25,26,27,30,7)]
...
```{r}
Accident.rf = randomForest(Accident_Severity~.,data=AccidentData.train,mtry=sqrt(10),importance=TRUE)
print (Accident.rf)
```
